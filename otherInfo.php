		   				...
		   				<div class="tab-pane active"  id="otherAct">
						    <div class="panel-heading">
						     ...
						     <br>
								   ...
								   <div id="oth">
		          					 <label>Details</label> 
				    					<input type="text" class="form-control required" name="actDetails" title="Please Enter The Details"><br>
			 					   </div>
			 				     </div>
			   					...
			   					<form role="form" name="enclosures" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" id="enclosureForm">
								    ...
								    <div id="enc">
		          					  <label>Enclosures</label> 
				    					 <input type="text" class="form-control required" name="encDetails" title="Please Enter The Enclosures"><br>				
			 					    </div>
			 				     </div>
