   	   ...
   	   <div class="row">
		   ...
		   <div class="col-sm-5">
					...
					<center><b> <br><br>Manage Your PBAS Account<br><br></b>
						...
						<br><a class="icon-download-alt" href="fpdf17/PDF1.php"> Click Here To See The Report</a>
						
					</center>

			</div>
		    
			<div class="col-sm-4" data-bind="visible: linksEnabled"><br>
				...
				<div class="panel panel-primary shadow">
					...
					<div class="panel-body">
						 <a class="btn btn-default btn-md" style="color:#428bca; width:100%;" href="teachingLearning.php">1. Teaching Learning & <br>Evalution Related Activities</a></br></br>
						<a class="btn btn-default btn-md" style="color:#428bca; width:100%;" href="curricularActivities.php">2. Co-Curricular,Extension,Professional <br>Development Related Activity</a></br></br>
						<a class="btn btn-default btn-md" style="color:#428bca; width:100%;" href="researchPublication.php">3. Research Publiaction & <br>Academic Contribution</a> </br></br>
