...
<?php
	if($name == 'curr'){
		$sql="SELECT * FROM teach_ecfa WHERE User_Id = '$userId' and Teach_ECFA_TOA = '".$val."'";
...
?>
	       <label>Type of Activity</label> 
				<input type="text" class="form-control required" name="typeOfActivity" title="Please Enter The Type of Activity" value="<?php echo $type; ?>">
 ...
 <?php
	...
	if($name == 'contr'){
		$sql="SELECT * FROM teach_clmi WHERE User_Id = '$userId' and Teach_CLMI_TOA = '".$val."'";
		$result = mysqli_query($con,$sql) or die('Error'.mysqli_error($con));
		$row = mysqli_fetch_array($result);
 ...
 ?>
 		<label>Type of Activity</label> 
			<input type="text" class="form-control required" name="typeOfActivity" title="Please Enter Type of Activity" value="<?php echo $type; ?>">
 ...
 <?php
	...
	if($name == 'dev'){
		$sql="SELECT * FROM teach_pda WHERE User_Id = '$userId' and Teach_PDA_TOA = '".$val."'";
		$result = mysqli_query($con,$sql) or die('Error'.mysqli_error($con));
		$row = mysqli_fetch_array($result);
