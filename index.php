<?php
	...
	if(isset($_POST['signUp'])){
		...
		if($row['User_Id'] == $userID){	
			$_SESSION['failure'] = "<h5 class='alert alert-danger' aligh='center'><strong>OOPS !!</strong> Please Enter Valid Information !!</h5>";
			header('location:index.php');
		}
		else{
			$query = mysqli_query($con, "Insert Into userinfo values('$userID','$regPass')") or die("Error : ".mysqli_error()); 
			$_SESSION['success'] = "<h5 class='alert alert-success' aligh='center'>Registration Successfull !!</h5>";
			header('location:index.php');
		}
	}
?>
			  ...
			  <div class="modal-body">
					<form class="form-horizontal" role="form">
					  <div class="form-group">
						...
						<div class="col-sm-10">
						  <input type="email" class="form-control" id="forgotEmail" data-toggle="popover" title="A Title" data-content="And here's some amazing content. It's very engaging. right?" placeholder="Email">
						</div>
					  </div>
					  <div class="form-group">
