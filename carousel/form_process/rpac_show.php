...
?>
	...
	<form method="post" name="ppij" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
		       <tr> <td>Title With Page Numbers </td><td><input type="text" name="PPIJ_TNO" value="<?php echo $PPIJ_TNO; ?>"></td></tr>
              <tr> <td> Journal </td><td><input type="text" name="PPIJ_Journal"  value="<?php echo $PPIJ_Journal; ?>"/></td></tr>
		       <tr> <td>ISSN / ISBN No. </td><td><input type="text" name="PPIJ_ISBN"  value="<?php echo $PPIJ_ISBN; ?>"/></td></tr>
		     <tr> <td>  Whether peer reviewed. IMpact factor, if any</td><td> <input type="text" name="PPIJ_PR"  value="<?php echo $PPIJ_PR; ?>"/></td></tr>
		      <tr> <td> No. of Co-authors </td><td><input type="text" name="PPIJ_NCA"  value="<?php echo $PPIJ_NCA; ?>"/></td></tr>
		      <tr> <td>Whether you are the main Author </td><td><input type="radio" name="PPIJ_YN" >Yes <input type="radio" name="PPIJ_YN">NO<br /></td></tr>
		     <tr> <td> API Score </td><td><input type="text" name="PPIJ_API"  value="<?php echo $PPIJ_API; ?>"/></td></tr>
			  <tr><td colspan="2"><br />
