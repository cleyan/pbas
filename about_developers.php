<?php include 'base_full_width.php' ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
			...
			<p>This is our development team, who have contributed to the developement of the IIPS website and made this possible to deploy this website within the time.  * The names below are in no particular order. *</p>
        </div>
